...
>
> IN THIS README OR  ARTICLE ABOUT THIS REPO - SAID SOME PROBLEMS , WHICH IS SOLVED BY DESIGN. BUT ITS NEEDED TO KNOWN BY WHO WANTS TO CONTRIBUTE.ALSO ONLY SAID WELL KNOWN RUNTIMES (INFERENCES) , MAY BE NEW RUNTIMES (IF COMES) , NEEDED TO ADD THAT ALSO , IF IT IS MORE BETTER - SO MORE OPTIMIZED. BUT ADDS COMPLEXITY AGAIN. SECURITY AND PERFORMANCE IS CRITICAL FOR AN OS , SO ITS NEEDED.
